        ...
        <div className="space-y-6 text-sm text-gray-300 leading-relaxed">
          ...
          <section>
            ...
            <ul className="space-y-1.5 text-gray-400">
              ...
              <li>• 엽전 1냥의 가격은 1,900원입니다. 현재 판매 패키지는 1냥(1,900원, 유상 1냥), 5냥(9,500원, 유상 5냥+보너스 1냥, 총 6냥), 10냥(19,000원, 유상 10냥+보너스 2냥, 총 12냥)입니다.</li>
              <li>• 신규 사주 전체보기는 엽전 1냥을 차감하며, 같은 풀이는 이후 무료로 다시 볼 수 있습니다. 기존에 결제로 연 풀이 권한은 유지됩니다.</li>
            </ul>
          </section>
