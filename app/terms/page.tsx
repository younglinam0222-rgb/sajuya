        ...
        <div className="space-y-6 text-sm text-gray-300 leading-relaxed">
          ...
          <section>
            ...
            <ul className="space-y-1.5 text-gray-400">
              ...
              <li>• 엽전 1냥의 가격은 1,900원입니다. 현재 판매 패키지는 1냥(1,900원), 5냥(9,000원, 정가 9,500원 대비 500원 할인), 10냥(18,000원, 정가 19,000원 대비 1,000원 할인)입니다. 신규 패키지에는 보너스가 포함되지 않으며, 이전에 지급된 보너스 잔액과 구매 내역은 유지됩니다.</li>
              <li>• 신규 사주 전체보기는 무료 판결문 3개(성격·재물운·애정운) 이후, 나머지 판결문·족집게 질문 답변·인생 전략을 엽전 1냥으로 생성합니다. 같은 풀이는 이후 무료로 다시 볼 수 있습니다. 기존에 결제로 연 풀이 권한은 유지됩니다.</li>
            </ul>
          </section>
