    ...
    <>
      ...
      <section id="article-4">
        ...
        <ul className="space-y-1.5 text-gray-400">
          ...
          <li>• 엽전 한냥의 가격은 1,900원이며, 세냥 패키지 구매 시 4,900원의 할인가로 이용할 수 있습니다.</li>
  ...
  return (
    <>
      ...
      <section id="article-4">
        ...
        <ul className="space-y-1.5 text-gray-400">
          <li>• 엽전은 서비스 내 유료 콘텐츠 이용을 위한 선불 전자적 수단입니다.</li>
          <li>• 확정 단가: 엽전 한냥 = 1,900원.</li>
          <li>• 현재 Production에 표시되는 판매 구성: 한냥(1,900원), 세냥 패키지(4,900원).</li>
          ...
          <li>• 가입 시 한냥이 지급될 수 있고, 출석 보상으로 무료 엽전이 지급될 수 있습니다. 유상 구매 엽전과 무료·보너스 엽전은 구분하여 기록하는 것이 원칙이나, Production 잔액은 단일 숫자로 관리되고 있습니다.</li>
      ...
      <section id="refund" className="scroll-mt-6">
        ...
        <ul className="space-y-1.5 text-gray-400">
          <li>• 화면 가격: 한냥 1,900원, 세냥 4,900원.</li>
        ...
        <ul className="space-y-1.5 text-gray-400">
          <li>• 신규 판매 패키지 초안: 한냥 1,900원, 다섯냥 9,000원, 열냥 18,000원. 신규 패키지 보너스 0. 과거 5+1·10+2 보너스 잔액은 보존하는 설계.</li>
          <li>• 사주 전체보기: 무료 판결문 3개 이후 나머지 유료 본문을 한냥 예약·차감하는 설계.</li>
