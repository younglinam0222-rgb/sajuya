...
export const MENUS: MenuItem[] = [
  ...
  { href: '/daeun',   label: '대운 해설',   desc: '10년 주기 큰 흐름',           emoji: '🌊', badge: '이용권 준비 중', badgeColor: '#8BAB98', paid: false },
  { href: '/taekil',  label: '택 · 일',    desc: '좋은 날짜 골라줌',            emoji: '📅', badge: '이용권 준비 중', badgeColor: '#8BAB98', paid: false },
  { href: '/yearly',  label: '연도별 운세', desc: '특정 연도 운세 분석',          emoji: '📆', badge: '이용권 준비 중', badgeColor: '#8BAB98', paid: false },
